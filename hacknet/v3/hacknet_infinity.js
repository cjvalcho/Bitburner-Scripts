...
export async function main(ns) {
    ...
    while (true) {
        ...
        if (ns.hacknet.getPurchaseNodeCost() < setAllowance(pct) && ns.hacknet.numNodes() < maxNodes) {
        ...
        for (let i = 0; i < ns.hacknet.numNodes(); i++) {
            ...
            if (i === (maxNodes - 1) && topRoI === 0) {
                ...
                ns.kill('/v3/hacknet_infinity.js', ns.getHostname()); // Use if pct is hardcoded
                //ns.kill('/v3/hacknet_infinity.js', ns.getHostname(), pct); // Use if pct is an input
            }
        }
