...
export async function main(ns) {
    ...
    let ramPerThread = ns.getScriptRam("/v1/early-hack-template.js");
    for (let serverName of servers) {
        await ns.scp("/v1/early-hack-template.js", serverName);
        ...
        if (ns.hasRootAccess(serverName)) {
            ...
            if (threads > 0) {
                ns.exec("/v1/early-hack-template.js", serverName, threads, "n00dles");
            }
        }
    }
}